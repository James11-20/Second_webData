...
public class DataHandler {
    ...
    public UniverityDatatype[] getData(){
        ...
        try{
            ...
            System.out.println("Lost connecteion to sever");
        }
        if(response == null){
        ...
        var UnivData = jsonParser.fromJson(responseBody,UniverityDatatype[].class);
        return UnivData;

    }

    class UniverityDatatype{
